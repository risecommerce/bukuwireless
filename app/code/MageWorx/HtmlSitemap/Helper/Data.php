...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    /**
     * Retrive the usage of category display mode
     *
     * @param int $storeId
     * @return bool
     */
    ...
    /**
     * Retrive product URL length (usage categories in product URL)
     *
     * @param int $storeId
     * @return int
     */
    ...
    /**
     * Retrive category-product sort order
     *
     * @param int $storeId
     * @return int
     */
    ...
    /**
     * Retrive sitemap page meta description
     *
     * @param int $storeId
     * @return string
     */
    ...
    /**
     * Retrive sitemap page meta keywords
     *
     * @param int $storeId
     * @return string
     */
